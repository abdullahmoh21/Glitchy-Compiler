...
def throw(exception, line=None):
    """
    Raises an exception and handles it by printing only the error message without a stack trace.
    This hides python from the user. We also raise a Exit exception that exits the current stage of compilation
...
def report(message, type="Complier", line=None):
    """
